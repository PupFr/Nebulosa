...
echo ""
echo "🔗 URL de prueba:"
echo "https://zoom.us/oauth/authorize?response_type=code&client_id=K3t8Sd3rSZOSKfkyMftDXg&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fauth%2Fzoom%2Fcallback&scope=meeting%3Aread%20meeting%3Awrite%20user%3Aread&state=test123"
